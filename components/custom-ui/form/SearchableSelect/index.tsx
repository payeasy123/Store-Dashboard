...
export const SearchableDropdown = (props: SearchableDropdownProps) => {
    ...
    return (
        <div className="relative w-full max-w-xs" ref={dropdownRef}>
            <button
                type="button"
                className="focus:ring-primary flex w-full items-center justify-between rounded-md border border-gray-300 bg-white px-4 py-2 text-left shadow-sm focus:outline-none focus:ring-2"
