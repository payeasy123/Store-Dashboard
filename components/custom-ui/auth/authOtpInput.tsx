...
export const OtpInput = ({ value, valueLength, onChange }: IOtpProps) => {
    ...
    return (
        ...
        <div className=" m-auto my-[1em] flex w-full max-w-[300px] items-center justify-between gap-[10px]">
            {valueItems.map((digit, idx) => (
                <input
                    ...
                    className="caret-primary focus:outline-primary h-[48px] w-[48px] rounded-[5px] border border-[#333754] text-center text-3xl font-bold transition-all duration-300 ease-in-out "
                    value={digit}
